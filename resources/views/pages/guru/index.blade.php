                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('guru.create') }}"><button class="btn btn-primary  btn-sm" type="button"
                                    style="float:right; text-transform: lowercase !important; letter-spacing: 2px"><i
                                        class="fa fa-plus">Tambah</i></button></a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="display guru_table"  width="100%php" id="basic-2">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>NIP</th>
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    if (response.success) {
                                        ...
                                        var oTable = $('#basic-2').DataTable(); //inialisasi datatable
                                        oTable.ajax.reload();
                                    }
                                }
